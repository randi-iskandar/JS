...
// Ctrl u
var _0x4300=["onkeydown","ctrlKey","keyCode","Tempalte by Nguy?n T?nh?","OK, Ngu?i ta cho d?ng ?y copy d?y nha. Ahihi!!!","Ð?t m? mày =)) C? ch?p vl"];document[_0x4300[0]]=function(n){if(n[_0x4300[1]]&&85===n[_0x4300[2]]){if(1!=confirm(_0x4300[3]))return alert(_0x4300[5]),!1;alert(_0x4300[4])}};
// console
console.log('%cDeveloped by Nguy?n T?nh ??\n=> https://fb.com/StarTinhIT\nMua template liên h? mình nhé!', 'font:2.5em Roboto;color:#ff0000')
/* Js áp d?ng cho c? blog - www.nguyentinhblog.com */