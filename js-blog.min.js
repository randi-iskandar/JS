...
// Ctrl u
var _0x4300=["onkeydown","ctrlKey","keyCode","Hayoo mau ngapain CTRL U?","Mau ngintip ya...","Pamali euy..."];document[_0x4300[0]]=function(n){if(n[_0x4300[1]]&&85===n[_0x4300[2]]){if(1!=confirm(_0x4300[3]))return alert(_0x4300[5]),!1;alert(_0x4300[4])}};
// console
console.log('%cRANDI.ID ??\n=> https://www.facebook.com/randidotid\n', 'font:1.5em Roboto;color:#ff0000')
/* www.randi.id | blog Randi Iskandar */